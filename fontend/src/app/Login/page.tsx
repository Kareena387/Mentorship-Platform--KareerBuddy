...
//     return (
//         <div className="relative flex items-center justify-center min-h-screen bg-cover bg-center" style={{ backgroundImage: "https://cdn.pixabay.com/photo/2019/03/03/20/23/background-4032775_640.png" }}>
//             <div className="absolute inset-0 bg-green-600 opacity-40"></div> {/* White overlay with 20% opacity */}
