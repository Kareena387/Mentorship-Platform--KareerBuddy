...
// const MentorProfile = () => {
//     const { id: mentorId } = useParams(); // Get the `id` from the URL
//     const router = useRouter();
...
//     useEffect(() => {
//         if (mentorId) {
//             // Fetch mentor details from the backend API
...
//                                     <h2 className="font-semibold text-green-500 mb-2">About</h2>
//                                     <p className="text-gray-600">
//                                         Dedicated educator with a passion for helping students reach their full
//                                         potential. Specializing in personalized learning and cognitive
...
//                                         <div className="flex justify-between items-center mb-2">
//                                             <span
//                                                 className={`text-sm text-green-500 font-bold px-2 py-1 rounded ${course.bgColor}`}
//                                             >
//                                                 {course.level}
//                                             </span>
//                                             <div className="flex items-center gap-1 text-sm text-gray-600">
...
import { Facebook, Twitter, Linkedin, ChevronLeft, MapPin, Mail, Briefcase, Users } from "lucide-react"; // Import icons from react-feather
import Footer from "@/components/footer";
import Navbar from "@/components/navbar";
...
interface Mentor {
    ...
    workingExperience: string;
    profilePicture: string;
    courses: Array<any>; // Adjust based on actual course data structure
}
...
const MentorProfile = () => {
    ...
    // const id = searchParams.get('mentorId');
    const id = "6744b65e4a101b420ab45d35";
